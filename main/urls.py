...
urlpatterns = [
    path('', views.Index.as_view(),
         name='index'),
    path('kontakt/', views.Contact.as_view(),
         name='contact'),
    path('katalog/', views.Catalog.as_view(),
         name='catalog'),
    path('katalog/create-category', views.CreateProductCategory.as_view(),
         name='create-category'),
    path('katalog/<slug:category_slug>/', views.CategoryProducts.as_view(),
    ...
    path('katalog/<slug:category_slug>/create', views.CreateProduct.as_view(),
         name='create-product'),
